Contributing to GLPM Core
============================

The GLPM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GLPM Core project, and is not to be
confused with overall GLPM Network Protocol consensus changes.

Whether a pull request is merged into GLPM Core rests with the project merge
...
Patches that change GLPM consensus rules are considerably more involved than
...
Where a patch set proposes to change the GLPM consensus, it must have been
...
The project leader is the release manager for each GLPM Core release.
