...
In order to support loading of multiple wallets in GLPM-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is GLPM.cpp.
...
Changes to GLPM.cpp
----------------------
GLPM.cpp is the entry point into GLPM-qt, and as such, will require some minor modifications to provide hooks for
