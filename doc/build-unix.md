UNIX BUILD NOTES
====================
Some notes on how to build GLPM in Unix.
...
memory available when compiling GLPM Core. With 512MB of memory or less
...
If you want to build GLPM-Qt, make sure that the required packages for Qt development
...
# Pick some path to install BDB to, here we create a directory within the GLPM directory
BDB_PREFIX="${GLPM_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure GLPM Core to use our own-built instance of BDB
cd $GLPM_ROOT
