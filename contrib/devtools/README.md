...
Setup
---------
Configuring the github-merge tool for the GLPM repository is done in the following way:

    git config githubmerge.repository GLPM-Project/GLPM
...
A script to optimize png files in the GLPM
