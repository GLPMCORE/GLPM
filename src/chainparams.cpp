...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Hello GLPM2";
...
/*
       ...
       vSeeds.push_back(CDNSSeedData("149.28.231.161", "149.28.231.161"));
       vSeeds.push_back(CDNSSeedData("144.202.7.115", "144.202.7.115"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.GLPM.io", "testnet.GLPM.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.GLPM.io", "testnet1.GLPM.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.GLPM.io", "testnet2.GLPM.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // GLPM: 1 day
        nTargetSpacing = 1 * 60;        // GLPM: 1 minutes
