                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received GLPM from zGLPM"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGLPM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGLPM));
