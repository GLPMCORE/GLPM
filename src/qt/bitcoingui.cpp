                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GLPM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GLPM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GLPM: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGLPM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GLPM Core"), this);
    aboutAction->setStatusTip(tr("Show information about GLPM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GLPM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GLPM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GLPM addresses"));
    ...
    openAction->setStatusTip(tr("Open a GLPM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GLPM Core help message to get a list with possible GLPM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GLPM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GLPM network", "", count));
}
...
{
    QString strTitle = tr("GLPM Core"); // default title
